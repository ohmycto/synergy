fields = {
   ...
   product_permalink: "Часть URL, по которой данный товар будет доступен (постоянная ссылка, SEO-атрибут).<br />Допустимые символы: буквы и цифры латинского алфавита (любой регистр), знак подчеркивания \"-\", знак минуса \"-\".",
   ...
   page_slug: "Часть URL, по которой данная страница будет доступна (постоянная ссылка, SEO-атрибут).<br />Допустимые символы: буквы и цифры латинского алфавита (любой регистр), знак подчеркивания \"-\", знак минуса \"-\".",
